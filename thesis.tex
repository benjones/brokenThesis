...
\algblockdefx{StartInterleave}{EndInterleave}
[0]{\textbf{Interleave and Iterate}}
[0]{}
...
\definecolor{newColor}{rgb}{1.0, 0.0, 0.0}
\newcommand{\newStuff}[1]{{\color{newColor} #1}}
...
%\include{relatedWork}
%\include{deformationEmbedding}
%\include{dynamicSprites}
%\include{exampleBasedPlastic}
%\include{conclusion}
